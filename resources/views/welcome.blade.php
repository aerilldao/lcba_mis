    ...
    <div class="container">
        <header class="header-container fade-in" style="position: relative;">
            <div style="position: absolute; top: -20px; right: 0;">
                 <button onclick="toggleDarkMode()" class="btn-login" style="padding: 0.5rem; border-radius: 50%; width: 40px; height: 40px; display: flex; align-items: center; justify-content: center; background: var(--bg-main); color: var(--text-main); border: 1px solid var(--card-border); cursor: pointer;">
